...
export function MarketInsights() {
  return (
    <section
      id="insights"
      className="relative border-t border-white/10 bg-[#070707] py-20 sm:py-28"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div className="grid gap-6 sm:gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
          <div className="relative transform-gpu rounded-[1.75rem] border border-white/12 bg-[#151515] p-6 shadow-[0_40px_120px_-80px_rgba(0,0,0,0.65)] sm:rounded-[2.5rem] sm:p-10">
          ...
          <div className="grid gap-5">
            {marketInsights.map((item) => (
              <article
                key={item.label}
                className="relative transform-gpu rounded-[1.5rem] border border-white/10 bg-zinc-950 p-6 shadow-2xl shadow-black/30 sm:rounded-[2rem] sm:p-7"
              >
